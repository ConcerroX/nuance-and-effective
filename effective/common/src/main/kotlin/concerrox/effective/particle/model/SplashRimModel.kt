...
class SplashRimModel<T : Entity?>(root: ModelPart) : EntityModel<T>() {
    ...
    companion object {
        val MODEL_LAYER: ModelLayerLocation = ModelLayerLocation(id("splash_rim"), "main")
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            modelPartData.addOrReplaceChild("splash_rim",
